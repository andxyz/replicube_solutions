...
Y=y^2
if Y>=9 then return -- get out early
else
	-- check interior escape hatches
	local X,Z=x^2,z^2
	if (X<=9 and Z==36 or Z<=9 and X==36) then return end
	if max(abs(x),abs(z))<=4 then 
...
-- return abs(y)<=2 and y^2+z^2*2-x^2 - 52 < 9 and x^2*2+y^2-z^2 - 47<16 and GREY
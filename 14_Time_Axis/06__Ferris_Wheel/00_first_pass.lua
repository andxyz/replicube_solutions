...
plane= y==-9 and sdBox2d(x, z, 18/2, 18/2) or 1
...
bridge= sdSegment(x, y, z, 0, 2, -2, 0, 2, 2) or 1
ferris_frame= min(circ,segment1,segment2,segment3,segment4)
--legs = Z==9 and sdOrientedBox(x, y, z, -5, -8, 0, 2, 10) or 1

if plane<=0 then return GREEN end -- grass

if ferris_frame==0 then return WHITE end -- legs
if bridge<=0 then return GREY end -- bridge between legs


--if sdf3_segment < 0.5 then
--	print(sdf3_segment) 
--	return BLACK 
--end
--